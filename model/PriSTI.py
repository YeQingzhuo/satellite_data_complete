...
from model.diff_models_PriSTI import Guide_diff
...
class PriSTI_PM25(PriSTI):
    def __init__(self, config, device, target_dim=36, seq_len=24):
        super(PriSTI_PM25, self).__init__(target_dim, seq_len, config, device)
        self.config = config
...
class PriSTI_ETTh1(PriSTI):
    def __init__(self, config, device, target_dim=7, seq_len=24): # 207为特征个数
        super(PriSTI_ETTh1, self).__init__(target_dim, seq_len, config, device)
        self.config = config
...
class PriSTI_Satellite(PriSTI):
    def __init__(self, config, device, target_dim=11, seq_len=60):
        super(PriSTI_Satellite, self).__init__(target_dim, seq_len, config, device)
        self.config = config
...
class PriSTI_sun(PriSTI):
    def __init__(self, config, device, target_dim=12, seq_len=60):
        super(PriSTI_sun, self).__init__(target_dim, seq_len, config, device)
        self.config = config
