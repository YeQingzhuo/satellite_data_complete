...
def train_NTC_with_Predata(lr,WX,batch_size,sample_rate,embedding_dim,epoches,nc,count,num_day,window_size,stride,data_name,data_pth,result_pth,save_dir_pth): 
    num_epoches = epoches
...
result_pth='../matrix_filling_pq/result/NTC/Satellite/result_2.txt'
save_dir_pth = '../matrix_filling_pq/save_model/NTC/Satellite/2/'


train_NTC_with_Predata(lr,WX,batch_size,sample_rate,embedding_dim,epoches,nc,count,num_day,window_size,stride,data_name,data_pth,result_pth,save_dir_pth)
print("over")
