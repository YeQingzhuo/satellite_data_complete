...
def train_costco(lr,batch_size,sample_rate,embedding_dim,epoches,nc,num_day,data_name,data_pth,result_pth,save_dir_pth): 
...
train_costco(lr,batch_size,sample_rate,embedding_dim,epoches,nc,num_day,data_name,data_pth,result_pth,save_dir_pth)
print("over")
