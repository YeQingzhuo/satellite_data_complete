...
def train_costco_with_Predata(lr,WX,batch_size,sample_rate,embedding_dim,epoches,nc,count,num_day,window_size,stride,data_name,data_preprocess_full_name,data_pth,data_preprocess_full_pth,result_pth,save_dir_pth): 
    num_epoches = epoches
...
train_costco_with_Predata(lr,WX,batch_size,sample_rate,embedding_dim,epoches,nc,count,num_day,window_size,stride,data_name,data_preprocess_full_name,data_pth,data_preprocess_full_pth,result_pth,save_dir_pth)
print("over")
