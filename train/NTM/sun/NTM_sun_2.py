...
stride = 2
data_name = 'sun_3D'
data_pth='../matrix_filling_pq/data/sun/sun_3D.mat'
result_pth='../matrix_filling_pq/result/NTM/sun/result_2.txt'
save_dir_pth = '../matrix_filling_pq/save_model/NTM/sun/2/'
