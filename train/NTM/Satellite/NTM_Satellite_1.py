...
def train_NTM(lr,batch_size,sample_rate,embedding_dim,epoches,nc,num_day,data_name,data_pth,result_pth,save_dir_pth): 
...
save_dir_pth = '../matrix_filling_pq/save_model/NTM/Satellite/1/'


train_NTM(lr,batch_size,sample_rate,embedding_dim,epoches,nc,num_day,data_name,data_pth,result_pth,save_dir_pth)
print("over")
