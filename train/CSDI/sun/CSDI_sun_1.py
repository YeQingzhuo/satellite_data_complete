...
from model.CSDI import CSDI_sun
from dataset_sun import get_dataloader,get_dataloader_add_history
...
foldername = "./save_CSDI/sun_nfold" + str(args.nfold) + "_X1_" + current_time + "/"
...
def train_CSDI(lr,num_epoches,current_day,num,nsample,result_pth):
    ...
    model = CSDI_sun(config, args.device).to(args.device)   
