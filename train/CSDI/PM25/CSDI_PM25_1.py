...
from model.CSDI import CSDI_PM25
from dataset_pm25 import get_dataloader,get_dataloader_add_history
...
foldername = "./save_CSDI/pm25_nfold" + str(args.nfold) + "_X1_" + current_time + "/"
