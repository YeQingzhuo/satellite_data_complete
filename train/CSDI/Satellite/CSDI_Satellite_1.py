...
foldername = "./save_CSDI/Satellite_nfold" + str(args.nfold) + "_X1_" + current_time + "/"
...
def train_CSDI(lr,num_epoches,current_day,num,nsample,result_pth):
...
train_CSDI(lr=lr,num_epoches=num_epoches,current_day=current_day,num=num,nsample=nsample,result_pth=result_pth)
print("over")
