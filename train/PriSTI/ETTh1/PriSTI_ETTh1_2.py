...
from model.PriSTI import PriSTI_ETTh1
from dataset_ETTh1_PriSTI import get_dataloader,get_dataloader_add_history
...
parser.add_argument("--adjfile", type=str, default="ETTh1") 
...
config["diffusion"]["adj_file"] = 'ETTh1'
...
foldername = "./save_PriSTI/ETTh1_outsample" + str(args.nfold) + "_X1_" + current_time + "/"
...
def train_PriSTI_add_history(lr,num_epoches,current_day,num,nsample,WX,window_size,stride,data_name,result_pth,data_file_path,Normal,data_preprocess_full_pth,data_preprocess_full_name):
    model = PriSTI_ETTh1(config, args.device).to(args.device)    
