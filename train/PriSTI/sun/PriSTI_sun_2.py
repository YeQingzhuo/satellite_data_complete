...
from model.PriSTI import PriSTI_sun
from dataset_sun_PriSTI import get_dataloader,get_dataloader_add_history
...
parser.add_argument("--adjfile", type=str, default="sun") 
...
foldername = "./save_PriSTI/sun_outsample" + str(args.nfold) + "_X1_" + current_time + "/"
...
def train_PriSTI_add_history(lr,num_epoches,current_day,num,nsample,WX,window_size,stride,data_name,result_pth,data_file_path,Normal,data_preprocess_full_pth,data_preprocess_full_name):
    model = PriSTI_sun(config, args.device).to(args.device)    
...
data_name = 'sun_3D'
data_file_path =  ' ../matrix_filling_pq/data/sun/sun_3D.mat'

result_pth = ' ../matrix_filling_pq/result  

data_preprocess_full_pth = ' ../matrix_filling_pq/data/data_preprocessing/sun_full.mat'
